...
<!-- gen:snapshot:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/stats-dark.svg?v=0b156e24">
  <img alt="Profile snapshot" src="assets/stats-light.svg?v=0b156e24" width="100%">
</picture>
<!-- gen:snapshot:end -->
...
<!-- gen:activity:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/activity-dark.svg?v=1e8d4ceb">
  <img alt="Contribution activity, last 12 months" src="assets/activity-light.svg?v=1e8d4ceb" width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/heatmap-dark.svg?v=4a7a3fe4">
  <img alt="Commit calendar, last 12 months" src="assets/heatmap-light.svg?v=4a7a3fe4" width="100%">
</picture>
<!-- gen:activity:end -->

...
<!-- gen:activity:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/activity-dark.svg?v=c267207c">
  <img alt="Contribution activity, last 12 months" src="assets/activity-light.svg?v=c267207c" width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/heatmap-dark.svg?v=f0f8fbc5">
  <img alt="Commit calendar, last 12 months" src="assets/heatmap-light.svg?v=f0f8fbc5" width="100%">
</picture>
<!-- gen:activity:end -->

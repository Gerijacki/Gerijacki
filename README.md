...
<!-- gen:activity:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/activity-dark.svg?v=850306b4">
  <img alt="Contribution activity, last 12 months" src="assets/activity-light.svg?v=850306b4" width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/heatmap-dark.svg?v=65ec2b7f">
  <img alt="Commit calendar, last 12 months" src="assets/heatmap-light.svg?v=65ec2b7f" width="100%">
</picture>
<!-- gen:activity:end -->

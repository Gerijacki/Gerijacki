...
<!-- gen:snapshot:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/stats-dark.svg?v=1287f67f">
  <img alt="Profile snapshot" src="assets/stats-light.svg?v=1287f67f" width="100%">
</picture>
<!-- gen:snapshot:end -->
...
<!-- gen:activity:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/activity-dark.svg?v=1388277c">
  <img alt="Contribution activity, last 12 months" src="assets/activity-light.svg?v=1388277c" width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/heatmap-dark.svg?v=203a9b3c">
  <img alt="Commit calendar, last 12 months" src="assets/heatmap-light.svg?v=203a9b3c" width="100%">
</picture>
<!-- gen:activity:end -->

...
<!-- gen:snapshot:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/stats-dark.svg?v=cd30fd5b">
  <img alt="Profile snapshot" src="assets/stats-light.svg?v=cd30fd5b" width="100%">
</picture>
<!-- gen:snapshot:end -->
...
<!-- gen:activity:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/activity-dark.svg?v=a13aea7f">
  <img alt="Contribution activity, last 12 months" src="assets/activity-light.svg?v=a13aea7f" width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/heatmap-dark.svg?v=ce334dac">
  <img alt="Commit calendar, last 12 months" src="assets/heatmap-light.svg?v=ce334dac" width="100%">
</picture>
<!-- gen:activity:end -->

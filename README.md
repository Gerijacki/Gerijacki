...
<!-- gen:activity:start -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/activity-dark.svg?v=5d8cd40d">
  <img alt="Contribution activity, last 12 months" src="assets/activity-light.svg?v=5d8cd40d" width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/heatmap-dark.svg?v=54db76f2">
  <img alt="Commit calendar, last 12 months" src="assets/heatmap-light.svg?v=54db76f2" width="100%">
</picture>
<!-- gen:activity:end -->
